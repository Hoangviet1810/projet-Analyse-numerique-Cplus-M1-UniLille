...
void verif_chaleur_explicite(double Tfinal, int N, const string& file) {
 ...
 int main() {
    ...
    int choix;
    cout << "Choisir la méthode:\n";
    cout << "1 - Euler explicite\n";
    cout << "2 - Euler implicite\n";
    cout << "Votre choix: ";
    cin >> choix;
    ...
    vector<int> Ns = {4, 8, 16, 32, 64, 128, 256};

    switch(choix){
        case 1: // Euler explicite
            for(int N : Ns){
                cout << "Résolution explicite pour N = " << N << endl;
                verif_chaleur_explicite(Tfinal, N, fichier);
            }
            break;
        case 2: // Euler implicite
            for(int N : Ns){
                cout << "Résolution implicite pour N = " << N << endl;
